story ="""Nemo is a young clownfish who lives with his father Marlin in an anemone in the Great Barrier Reef. 
...
word = input("What word would you like to find in the story?")
def search(story, word):
    if (story.find(word) == -1):
        print("Word not found ._.")
    else:
        print("The word was found at", story.find(word))
        print("number of times string found is", story.count(word))
search(story,word)